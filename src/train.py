...
trainings = [
    ("default",  "yolo11n", 0.015, 0.7, 0.6, 0.4),


for name, yolo_version, hsv_h, hsv_s, hsv_v, scale in trainings:
    ...
    results = model.train(
        ...
        name="run_NO_SCALING_150_NOISE_CLAHE_augmentation",
        ...
        scale=0.0,          # Scaling (default 0.5)                 # use 0 when tiling is off!
