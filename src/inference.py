...
#     "LO_mark": [f"../datasets/full_dataset/Second_Batch-PM251015p1-251022_post_LO_mark-dark-{i:06d}.jpg" for i in range(343, 346)],
...
# results = []
# for image_path in examples[EXAMPLE][:5]:  # Process all examples
#     t0 = cv2.getTickCount()
